...
-- 2. ENSURE CONSISTENT COLUMN ALIGNMENT FOR SHAREHOLDERS
ALTER TABLE public.shareholders 
ALTER COLUMN "ownershipPercentage" TYPE NUMERIC(5,2),
ALTER COLUMN "shareClass" TYPE TEXT,
ALTER COLUMN "issueDate" TYPE DATE;
